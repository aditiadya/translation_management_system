...
const VendorBankTransferDetail = sequelize.define(
  ...
  {
    tableName: "vendor_bank_transfer_details",
    timestamps: true,
  }
);

VendorBankTransferDetail.associate = (models) => {
  VendorBankTransferDetail.belongsTo(models.VendorPaymentMethod, {
    foreignKey: "payment_method_id",
    as: "payment_method",
  });
};

export default VendorBankTransferDetail;