...
const VendorUploadOutputFileModal = ({ jobId, onClose, onSuccess }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await api.post(`/vendor-jobs/${jobId}/upload-output`, formData, {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900">Upload Output File</h2>
...
export default VendorUploadOutputFileModal;
