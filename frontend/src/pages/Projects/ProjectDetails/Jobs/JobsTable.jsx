              ...
              data.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 text-xs whitespace-nowrap">
                    <Link
                      to={`/project/${projectId}/job/${row.id}`}
                  ...
                  <td className="px-3 py-2 text-xs text-center">
                    {row.auto_start_on_vendor_acceptance ? (
                      <span
                      ...
                      <span
                        className="inline-block w-4 h-4 bg-gray-300 rounded-full"
                        title="No"
                      ></span>
                    )}
                  </td>
                  ...
                  <td className="px-3 py-2 text-xs text-center whitespace-nowrap">
                    {row.previous_job_id ? (
                      <Link
                        to={`/project/${projectId}/job/${row.previous_job_id}`}
                        className="text-blue-600 hover:text-blue-800 underline"
                      >
                        J{row.previous_job_id}
                      </Link>
                    ) : (
                      "—"
                    )}
                  ...
                  <td className="px-3 py-2 text-xs text-center whitespace-nowrap">
                    {row.next_job_id ? (
                      <Link
                        to={`/project/${projectId}/job/${row.next_job_id}`}
                        className="text-blue-600 hover:text-blue-800 underline"
                      >
                        J{row.next_job_id}
                      </Link>
