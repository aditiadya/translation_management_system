      ...
      <div className="max-h-[420px] overflow-y-auto">
        <table className="w-full table-auto border-collapse">
          ...
          <colgroup>
            ...
            <col style={{ width: "7%" }} />   {/* PO */}
            <col style={{ width: "10%" }} />  {/* Service */}
            <col style={{ width: "12%" }} />  {/* Language Pair */}
            <col style={{ width: "4%" }} />   {/* Unit Amount */}
            <col style={{ width: "4%" }} />   {/* Unit */}
            <col style={{ width: "5%" }} />   {/* Price */}
            <col style={{ width: "4%" }} />   {/* Subtotal */}
            <col style={{ width: "6%" }} />   {/* Extra */}
            <col style={{ width: "4%" }} />   {/* Discount */}
            <col style={{ width: "3%" }} />   {/* Total */}
            <col style={{ width: "6%" }} />   {/* Currency */}
            <col style={{ width: "3%" }} />   {/* CAT */}
            <col style={{ width: "15%" }} />  {/* Filename */}
            <col style={{ width: "7%" }} />  {/* Internal Note */}
            <col style={{ width: "6%" }} />   {/* Issued at */}
